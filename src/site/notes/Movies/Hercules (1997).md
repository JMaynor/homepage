---
{"dg-publish":true,"permalink":"/movies/hercules-1997/","tags":["movies"],"created":"2024-07-20","updated":"2025-12-15","dg-note-properties":{"aliases":["Hercules"],"date created":"2024-07-20","date modified":"2025-12-15","director":null,"tags":["movies"]}}
---
...
Second, is I feel there are narrative structure issues here. Why is it that all the Gods get beat to hell but then Hercules shows up and suddenly they curbstomp Hades and the Titans? Even though Herc didn't really do all that much in that scene. The whole ending sequence is no good and really needs to be changed. But I don't know specifically what we should do to fix it. This one needs rewriting.
